...
const defaultKeyconfig = [
  ...
  [
    ...
    { key_name: 'Pause', width: width_min, height: height_min },
  ...
  [
    ...
    { key_name: 'Up', width: width_max, height: height_mid },
    { key_name: 'RShift', width: 0.85, height: height_mid },
  ],
  // Sixth row
  [
...
const alternativeKeyConfig = [
  // Example of an alternative configuration with some modifications
  // Top row
  [
    { key_name: 'Esc', width: width_min, height: height_min },
    { key_name: 'F1', width: width_min, height: height_min },
    ...
    { key_name: 'F11', width: width_min, height: height_min },
    { key_name: 'F12', width: width_min, height: height_min },
    { key_name: 'Home', width: width_min, height: height_min }, // Changed 'Snapshot' to 'Print'
    { key_name: 'End', width: width_min, height: height_min }, // Changed 'Scroll' to 'Pause'
    { key_name: 'Insert', width: width_min, height: height_min },
    { key_name: 'Delete', width: width_min, height: height_min },
  ],
  // Second row
  [
    { key_name: 'Kanji', width: width_max, height: height_mid },
  ...
  [
    ...
    { key_name: 'Convert', width: width_mid, height: height_max },
    { key_name: 'Hiragana', width: width_mid, height: height_max },
    { key_name: 'RAlt', width: width_arrow, height: height_max },
    { key_name: 'PrintScreen', width: width_arrow, height: height_max },
    { key_name: 'RCtrl', width: width_mid, height: height_max },
    { key_name: 'PageUp', width: width_arrow, height: height_max },
    { key_name: 'Up', width: width_arrow, height: height_max },
    { key_name: 'PageDown', width: width_arrow, height: height_max },
  ],
  ...
  // ... Other rows can be similarly modified for the alternative configuration
  // For brevity, only the top row is shown as an example
];

const keyConfigs = [
  {
    config_name: "SKB-KG3BKN2",
    key_config: defaultKeyconfig,
  },
  {
    config_name: "INTRO Mini CP",
    key_config: AS_PKMP85J_BKA,
  },
  {
    config_name: "Alternative",
    key_config: alternativeKeyConfig,
  },
